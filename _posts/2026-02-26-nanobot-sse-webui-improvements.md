---
layout: post
title: "nanobot 项目两项重要改进：SSE 流式响应与配置 Web UI 可视化"
date: 2026-02-26 11:11:00 +0800
categories: [技术博客, AI Agent, nanobot]
tags: [nanobot, SSE, Web UI, AI Agent]
---
...
支持配置模型名称、temperature、maxTokens、子 Agent 模型等参数。
